...
```{r}
# Fit the whole training set, then predict the test cases based on logit
logit_fit <- 
  final_logit |>
  last_fit(data_split)
...
importance_rf <- 
  importance_rf[order(importance_rf$Importance, decreasing = TRUE), ]

# plot the feature importance
p <- ggplot(importance_rf, 
