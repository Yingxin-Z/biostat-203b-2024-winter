...
labevents_tble <- tbl(con_bq, "labevents") |>
  ...
  left_join(
    ...
    by = "itemid") |>
  # If multiple values of the same item with the same storetime, use the one with the latest charttime.
...
mimic_icu_cohort |>
  ...
  gtsave("mimic_icu_cohort_gtsummary.html")
```

My tibble after preprocessing is saved in `mimic_icu_cohort` and the numerical summary is saved in `mimic_icu_cohort_gtsummary.html` and displayed above.
